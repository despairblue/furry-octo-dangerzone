...
graphical editor for \acr{SSIML} models, to describe \gls{3D} applications. Then
...
Figure \ref{fig:wheel} demonstrates multiple orientations a \gls{3D} model of a wheel can have. Picture a) to c) are common

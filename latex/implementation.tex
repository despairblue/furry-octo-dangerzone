...
window.angular.module('scegratooApp')
  ...
  \end{minted}
  \caption{This is how \gls{Roundtrip3D} is initialized. It also shows how the routing is defined.}
...
React is utilized by \gls{Roundtrip3D} to render the tree-view that gives a more

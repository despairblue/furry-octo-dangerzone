...
In the following sections the initial design concept of \gls{Roundtrip3D} is illustrated.
...
Tree-view-node can also be used to edit a scene-graph node's properties. When an

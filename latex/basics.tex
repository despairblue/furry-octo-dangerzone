...
The Figures \ref{blender} to \ref{fig:x3dgizmo} show different gizmos from
...
Using web sockets instead of AJAX is an well performing approach
...
clients on every change, or sending change sets, which poses the interesting
challenge of generating them. They visualize a specific dataset in a threejs's specific \gls{JSON} format

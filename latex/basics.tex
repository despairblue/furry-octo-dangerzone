...
Scene-graphs can be used to group and organize 3D objects, their properties and
...
universal interactive 3D exchange format, much like \gls{HTML}is for written
...
using a WebGL context. It is called x3dom \cite{x3dom} and it is extensively used
...
control system like git, just for \gls{3D} models.
...
SceGraToo's requirements and theirs outweigh the similarities. SceGraToo not only
